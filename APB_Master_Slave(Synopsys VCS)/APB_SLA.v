module APB_slave(input pCLK,pRESETn,pSELX,pENABLE,input pWRITE,input [3:0]pSTROBE,input [31:0]pWDATA,input [4:0]pADDR,output reg [31:0]pRDATA,output reg pREADY,pSLAVE_ERROR);
